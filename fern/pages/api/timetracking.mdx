...
<img src="/assets/api/timetracking-overview.webp" alt="awork time tracking analytics with project budget, tracked hours, and user totals" width="80%" align="center" />
