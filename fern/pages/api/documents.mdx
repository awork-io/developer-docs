...
### Creating a Document
To create a new document, you need to provide at least a name. Documents can be created in a document space, within a project, or as private documents.
