...
<Warning>
Latest rollout deadline for affected ERP/custom integrations: <strong>June 30, 2026</strong>.<br />
Upgrade your integration before <strong>June 30, 2026</strong> to avoid issues.
</Warning>

Rollout note:
- For workspaces with known ERP or custom integrations, the Workflows feature can remain deactivated until **June 30, 2026** at the latest.
- Integrations should be upgraded before **June 30, 2026** to avoid issues when Workflows are enabled.
...
- Complete this migration before **June 30, 2026** if your workspace currently has Workflows deactivated due to ERP/custom integrations.
...
Migration path (if you need to keep using global `GET /projectstatuses`, as many integrations currently do):
