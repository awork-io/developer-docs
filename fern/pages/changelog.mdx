...
3) If the project has a `workflowId` set, filter the global list of project statuses you retrieved earlier by this `workspaceId`. If it does not have a workflow set, use the `projectId` as before.
