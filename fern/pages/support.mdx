...
The **Trace-Id** is an awork-internal identifier that can identify a request. With this id, we can look up a particular request and use this to investigate potential issues and provide support.
